...
arena new_arena() {
    void *mem = malloc(
        sizeof(size_t) * INITIAL_ARENA_CAPACITY +
    ...
    expression *expressions = (expression *)(available + INITIAL_ARENA_CAPACITY);
...
typedef void print_expression_fn(
    arena *a,
...
static void print_expression(arena *a, expression_reference ref, size_t indent) {
...
static void print_function_literal(
    arena *a,
    expression_reference ref,
    size_t indent
) {
    ...
    expression_list arguments = 
        function_literal->function_literal.arguments;
    ...
    expression_reference body = 
        function_literal->function_literal.body;

    print_expression(a, body, indent);
}

static void print_list_literal(
    arena *a,
    expression_reference ref,
    size_t indent
) {
    ...
    expression_list expressions =
        list_literal->list_literal.values;
...
static void print_block_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
...
static void print_prefix_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
...
static void print_assign_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
...
static void print_infix_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
...
static void print_ternary_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
...
static void print_call_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
    ...
    expression_reference function = 
        call_expression->call_expression.function;
...
static void print_index_expression(
    arena *a,
    expression_reference ref,
    size_t indent
) {
    ...
    expression_reference list =
        index_expression->index_expression.list;
...
static void print_expression_list(
    arena *a,
    expression_list el,
    size_t indent
) {
